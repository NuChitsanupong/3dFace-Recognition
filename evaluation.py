...
from models import ResNet50, mobilenet, resnext50, vgg16


def evaluation(eval_dataset, pretrained_model_path, batch_size=16, 
               num_of_workers=0, num_of_classes=1200, is_resnet50=False,
               is_mobilenet=False, is_resnext50=False, is_vgg16=False):
    ...
    if is_resnet50:
        ...
        model = resnext50(eval_dataset.input_channels, num_of_classes, pretrained=False)
    elif is_mobilenet:
        model = mobilenet(eval_dataset.input_channels, num_of_classes, pretrained=False)
    elif is_vgg16:
        model = vgg16(eval_dataset.input_channels, num_of_classes, pretrained=False)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--test_dataset_csv', type=str,
                        ...
                        default='./3dvggface2_1_align2/test.csv')
...
if __name__ == '__main__':
    ...
    acc, loss = evaluation(test_dataset, batch_size=args.batch_size,
                           ...
                           is_resnet50=args.is_resnet50, is_resnext50=args.is_resnext50,
                           is_mobilenet=args.is_mobilenet, is_vgg16=args.is_vgg16)
